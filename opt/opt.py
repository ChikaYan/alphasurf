...
optim_surf = torch.optim.Adam(
            list(grid.surface_mlp.parameters()) + [grid.surface_data],
            lr=args.lr_surface
)
epoch_id = -1
while True:
