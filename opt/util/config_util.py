...
def setup_train_conf(return_parpser=False):
    ...
    group.add_argument('--fs_std_decay_type', type=str, default='exp', 
                        choices=['exp', 'linear', 'const'])
    ...
    group.add_argument('--lambda_inplace_alpha_sparsify', type=float, default=0.)
    group.add_argument('--lambda_inplace_surf_sparse', type=float, default=0.)
