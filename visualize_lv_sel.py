...
methods = {
    ...
    # r'Plenoxels ($\sigma=10$)': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/nerf/syn/ckpt_eval_cuvol/thresh_10/ckpt/imgs_pt_test_crop',
    # r'Plenoxels ($\sigma=30$)': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/nerf/syn/ckpt_eval_cuvol/thresh_30/ckpt/imgs_pt_test_crop',
    # r'Plenoxels ($\sigma=50$)': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/nerf/syn/ckpt_eval_cuvol/thresh_50/ckpt/imgs_pt_test_crop',
    # r'Plenoxels ($\sigma=70$)': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/nerf/syn/ckpt_eval_cuvol/thresh_70/ckpt/imgs_pt_test_crop',
    # r'Plenoxels ($\sigma=90$)': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/nerf/syn/ckpt_eval_cuvol/thresh_90/ckpt/imgs_pt_test_crop',
    # r'Plenoxels ($\sigma=100$)': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/nerf/syn/ckpt_eval_cuvol/thresh_100/ckpt/imgs_pt_test_crop',
    # r'Plenoxels ($\sigma=\tau$)': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/nerf/syn/ckpt_eval_cuvol/thresh_10,30,50,70,90/imgs_pt_test_crop',

    r'MipNeRF360 ($\sigma=10$)': '/rds/project/rds-qxpdOeYWi78/multinerf/results/blender/{}/pts/lv_10_pts/imgs_pt_test_crop',
    r'MipNeRF360 ($\sigma=30$)': '/rds/project/rds-qxpdOeYWi78/multinerf/results/blender/{}/pts/lv_30_pts/imgs_pt_test_crop',
    r'MipNeRF360 ($\sigma=50$)': '/rds/project/rds-qxpdOeYWi78/multinerf/results/blender/{}/pts/lv_50_pts/imgs_pt_test_crop',
    r'MipNeRF360 ($\sigma=70$)': '/rds/project/rds-qxpdOeYWi78/multinerf/results/blender/{}/pts/lv_70_pts/imgs_pt_test_crop',
    r'MipNeRF360 ($\sigma=90$)': '/rds/project/rds-qxpdOeYWi78/multinerf/results/blender/{}/pts/lv_90_pts/imgs_pt_test_crop',
    r'MipNeRF360 ($\sigma=100$)': '/rds/project/rds-qxpdOeYWi78/multinerf/results/blender/{}/pts/lv_100_pts/imgs_pt_test_crop',
    r'MipNeRF360 ($\sigma=\tau$)': '/rds/project/rds-qxpdOeYWi78/multinerf/results/blender/{}/pts/imgs_pt_test_crop',
    ...
    'Ours': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/good_trunc/solid_less_trunc/ckpt_eval_surf_masked/ckpt/imgs_pt_test_crop',
...
special_group_replace={
    ...
    'Ours': '/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/{}/norm_l12/norm_l12_decay_9_low_tv_2/ckpt_eval_surf_masked/ckpt/imgs_pt_test_crop',
...
out_path = 'paper/nerf_lvs.png'
out_path = 'paper/plen_lvs_tau.pdf'
# out_path = 'paper/mip_lvs.pdf'
