...
#! sbatch --array=0- ./hpc_train_eval_good_llff_tv.sh
...
SCENES=("rough" "glass_cup")

# SCENES=("plastic" "choco" "flower_thin" "trex" "fern" "orchids")
SCENES=("plastic" "rough" "fern")
...
# CONFS=("slv_fast_2" "slv_fast_3") 

BATCH_NAME="llff_resubmit"
CONFS=("mlv") 
...
do
    ...
    do
        ...
        python exract_points_no_cam.py $CKPT_DIR/$ckpt_name --downsample_density 0.001 \
            --out_path $PT_PATH --intersect_th 0.1 --n_sample 3 --scene_scale 1. --single_lv # --surf_lv_set -0.002
    ...
    #     python exract_points_no_cam.py $CKPT_DIR/$ckpt_name --downsample_density 0.001 \
    #         --out_path $PT_PATH --intersect_th -1 --n_sample 3 --single_lv --scene_scale 1.
