...
$BLENDER_PATH $SCENE_PATH --background --python /rds/project/rds-qxpdOeYWi78/plenoxels/opt/scripts/blender_render_train.py -- $SCENE_NAME $RESOLUTION

# python exr_to_pts.py ${SCENE_NAME}_$RESOLUTION

# $BLENDER_PATH $SCENE_PATH --background --python /rds/project/rds-qxpdOeYWi78/plenoxels/opt/scripts/blender_render_test.py -- $SCENE_NAME $RESOLUTION





#! sbatch --array=0- hpc_blender_render_low_res.sh