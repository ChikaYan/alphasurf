...
#! sbatch --array=0- ./hpc_train_eval_good_llff.sh
...
CONFS=(l12_norm_dilate_4 mid_2_l12_norm_dilate_4) 
CONFS=(l12_norm_dilate_8) 
CONFS=(fast_l12_norm_dilate_4) 
CONFS=(mid_l12_norm_dilate_4) 
CONFS=(mid_2_l12_norm_dilate_4) 

CONFS=(mid_l12_norm_dilate_4_mimic_2) 
# CONFS=(mid_l12_norm_dilate_4_mimic) 
