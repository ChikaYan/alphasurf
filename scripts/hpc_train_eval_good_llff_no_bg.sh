...
#! sbatch --array=0- ./hpc_train_eval_good_llff_no_bg.sh
...
SCENES=(glass_cup rough bag half_cup plastic)
# SCENES=(bag half_cup)
...
BATCH_NAME="llff_mlv"
CONFS=(mlv_fast) 
CONFS=(fast_high_l12_norm_dilate_8 fast_l12_norm_dilate_4) 
CONFS=(l12_norm_dilate_4) 
# CONFS=(mid_l12_norm_dilate_4 mid_2_l12_norm_dilate_4) 
# CONFS=(mlv_fast_d8) 
# CONFS=(fast_high_norm fast_high_tv) 
# CONFS=(fast_l12_norm) 
# CONFS=(fast_l12_norm_dilate_8) 

# CONFS=(fast_l12_norm_dilate_8_smooth) 
# CONFS=(fast_l12_norm_dilate_8_tv_edge) 
# CONFS=(fast_l12_norm_dilate_8_large_tv_edge) 
# CONFS=(fast_l12_norm_dilate_8_high_tv) 
# CONFS=(l12_norm_dilate_8) 
# CONFS=(fast_l12_large_norm_dilate_16 fast_l12_norm_dilate_16) 
...
do
    ...
    CONF_NAME=${CONF}.yaml
    EXP_NAME="tuning/$(basename $DATA_DIR)/$BATCH_NAME/synllff_no_bg/$(basename $CONF_NAME .yaml)"
    ...
    python opt.py -t $CKPT_DIR $DATA_DIR -c $CONFIG \
        --load_pretrain_density_sh "/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/$(basename $DATA_DIR)/nerf/synllff_no_bg" \
    # python opt.py -t $CKPT_DIR $DATA_DIR -c $CONFIG \
