...
#! sbatch --array=0- ./hpc_train_eval_good_llff_bg_no_tv.sh
...
SCENES=(glass_cup rough half_cup goblet)
...
BATCH_NAME="llff_mlv_bg"
CONFS=(fast_l12_norm) 
CONFS=(fast_l12_norm_no_tv_no_sparse) 
# CONFS=(fast_no_norm_no_tv_no_sparse) 
CONFS=(fast_no_norm_no_tv_no_sparse_d16) 
CONFS=(fast_no_norm_no_tv_no_sparse_d16_no_inherit) 
# CONFS=(fast_no_norm_no_tv_no_sparse_d16_no_inherit_n16) 
# CONFS=(fast_no_norm_no_tv_no_sparse_d16_no_inherit_n4) 
...
do
    ...
    CONF_NAME=${CONF}.yaml
    EXP_NAME="tuning/$(basename $DATA_DIR)/$BATCH_NAME/synllff_bg_no_tv/$(basename $CONF_NAME .yaml)"
    ...
    python opt.py -t $CKPT_DIR $DATA_DIR -c $CONFIG \
        --load_pretrain_density_sh "/rds/project/rds-qxpdOeYWi78/plenoxels/opt/ckpt/tuning/$(basename $DATA_DIR)/nerf/synllff_bg_no_tv" \
